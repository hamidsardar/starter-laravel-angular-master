💁 *hamidsardar/starter-laravel-angular has been upgraded to Laravel 5.1.0. You can pull the changes and run* `rm composer.lock && composer install --prefer-dist --no-scripts` *to merge the upgrade.*
...
## Installation
```
git clone https://github.com/hamidsardar/starter-laravel-angular.git
```
```
...
Have fun! Any feedback is welcome. Use [Issues](https://github.com/hamidsardar/starter-laravel-angular/issues). I’m looking forward to talk to you.
